...
DROP SEQUENCE SEQ_STUDY_REACTION;
DROP SEQUENCE SEQ_STUDY_COMMENT;
DROP SEQUENCE SEQ_STUDY_BOARD;
DROP SEQUENCE SEQ_STUDY_MEMBER;
...
-- ===========================================
-- 3️⃣ 게시판 테이블 생성 (회원 삭제시 게시글 유지)
-- ===========================================
CREATE TABLE STUDY_BOARD(
    BOARD_ID NUMBER PRIMARY KEY,
    BOARD_TYPE VARCHAR2(20),
    MEMBER_ID NUMBER REFERENCES STUDY_MEMBER(MEMBER_ID) ON DELETE SET NULL,
...
-- ===========================================
-- 4️⃣ 댓글 테이블 생성 (회원 삭제시 댓글 삭제)
-- ===========================================
CREATE TABLE STUDY_COMMENT(
    COMMENT_ID NUMBER PRIMARY KEY,
    BOARD_ID NUMBER NOT NULL REFERENCES STUDY_BOARD(BOARD_ID) ON DELETE CASCADE,
    MEMBER_ID NUMBER NOT NULL REFERENCES STUDY_MEMBER(MEMBER_ID) ON DELETE CASCADE,
    CONTENTS CLOB NOT NULL,
    REG_DATE TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL
);
...
CREATE OR REPLACE TRIGGER TRG_STUDY_REACTION_ID
...
-- ===========================================
-- 회원 2명
INSERT INTO STUDY_MEMBER (MEMBER_ID, EMAIL, PWD, NICKNAME) 
VALUES(SEQ_STUDY_MEMBER.NEXTVAL, 'a@test.com', '1234', 'USERA');

INSERT INTO STUDY_MEMBER (MEMBER_ID, EMAIL, PWD, NICKNAME) 
VALUES(SEQ_STUDY_MEMBER.NEXTVAL, 'b@test.com', '1234', 'USERB');
...
VALUES(SEQ_STUDY_BOARD.NEXTVAL, 'FREE', 1, '게시글 A', '내용 A');

INSERT INTO STUDY_BOARD (BOARD_ID, BOARD_TYPE, MEMBER_ID, TITLE, CONTENTS)
VALUES(SEQ_STUDY_BOARD.NEXTVAL, 'FREE', 2, '게시글 B', '내용 B');

-- 댓글 3개
INSERT INTO STUDY_COMMENT (COMMENT_ID, BOARD_ID, MEMBER_ID, CONTENTS)
VALUES(SEQ_STUDY_COMMENT.NEXTVAL, 1, 1, '댓글 A1');

INSERT INTO STUDY_COMMENT (COMMENT_ID, BOARD_ID, MEMBER_ID, CONTENTS)
VALUES(SEQ_STUDY_COMMENT.NEXTVAL, 1, 2, '댓글 A2');

INSERT INTO STUDY_COMMENT (COMMENT_ID, BOARD_ID, MEMBER_ID, CONTENTS)
VALUES(SEQ_STUDY_COMMENT.NEXTVAL, 2, 2, '댓글 B1');

-- 공감/신고 2개
INSERT INTO REACTION (REACTION_ID, MEMBER_ID, TARGET_TYPE, TARGET_ID, ACTION)
VALUES(SEQ_STUDY_REACTION.NEXTVAL, 1, 'BOARD', 2, 'LIKE');

INSERT INTO REACTION (REACTION_ID, MEMBER_ID, TARGET_TYPE, TARGET_ID, ACTION)
VALUES(SEQ_STUDY_REACTION.NEXTVAL, 2, 'COMMENT', 1, 'LIKE');
...
UPDATE STUDY_BOARD SET BOARD_TYPE = 'board1' WHERE BOARD_TYPE = 'FREE'; 
...
-- 테스터용
INSERT INTO STUDY_MEMBER (EMAIL, PWD, NICKNAME, REG_DATE) VALUES('tester', '1234', '테스터', SYSTIMESTAMP - INTERVAL '45' DAY);
